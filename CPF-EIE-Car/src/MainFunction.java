...
public class MainFunction {
	...
	public static void Process(double alpha1, double alpha2, double alpha3) {
		...
		String dir = workspace + "/cikm2016-cpf/Data/EIE/Car/"; // make sure you have the directory
		String res = workspace + "/cikm2016-cpf/Prediction/EIE/Car/cpf " + para + ".txt"; // make sure you have the directory
		...
		try {
			...
			for (int i = 0; i < nFolds; i++) {
				String paradir = workspace + "/cikm2016-cpf/Parameter/EIE/Car/";
