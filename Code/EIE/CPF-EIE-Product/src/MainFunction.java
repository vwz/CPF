...
public class MainFunction {
	...
	public static void Process(double alpha1, double alpha2, double alpha3) {
		...
		String para = String.format("alpha1_%.3f alpha2_%.3f alpha3_%.3f", alpha1, alpha2, alpha3);
		...
		String dir = workspace + "/cikm2016-cpf/Data/EIE/Product/"; // make sure you have the directory
		String res = workspace + "/cikm2016-cpf/Prediction/EIE/Product/cpf " + para + ".txt"; // make sure you have the directory
		...
		try {
			...
			for (int i = 0; i < nFolds; i++) {
				String paradir = workspace + "/cikm2016-cpf/Parameter/EIE/Product/";

				// training
				long tstart = System.currentTimeMillis();
				ParaClass param = ct.Configure(dir, i, paradir);
				...
				Evaluator eval = cd.Configure(dir, i, param, bw);
