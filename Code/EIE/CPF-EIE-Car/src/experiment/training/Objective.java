...
public class Objective {
	...
	private InferClass LoopyBP_P(dataStructure ds, ParaClass param, Map<String, String> labelDic) {
		...
		//System.out.println("check inf on LoopyBP_P");
		//DebugClass.CheckInf(gpc.nodePot, edgeStruct);
		//DebugClass.CheckInf(gpc.edgePot, edgeStruct);
	...
	public ComputeConstraintGradient OptimizeQ_Unlabeled(dataStructure ds, ParaClass param, Map<String, String> labelDic, InferClass inferP, InferClass inferQ) {
		...
		// special treatment for Verdict_MoreSpec_DriveRide
		if (gParam.w.containsKey("Verdict_MoreSpec_DriveRide")) {
			double value = gParam.w.get("Verdict_MoreSpec_DriveRide") * 0.1;
			gParam.w.put("Verdict_MoreSpec_DriveRide", value);
		}
	...
	public void OptimizePU_Prune(dataStructure ds, ParaClass param, Map<String, String> labelDic, Map<String, Double> m_cs, InferClass inferP, InferClass inferQ) {
		...
		// special treatment for Verdict_MoreSpec_DriveRide
		if (Eqzeta.containsKey("Verdict_MoreSpec_DriveRide")) {
			double value = Eqzeta.get("Verdict_MoreSpec_DriveRide") * 0.1;
			Eqzeta.put("Verdict_MoreSpec_DriveRide", value);
		}
		if (piterm.containsKey("Verdict_MoreSpec_DriveRide")) {
			double value = piterm.get("Verdict_MoreSpec_DriveRide") * 0.1;
			piterm.put("Verdict_MoreSpec_DriveRide", value);
		}
