...
public class ConfigDecode {
	...
	public Evaluator Configure(String dir, ParaClass param, BufferedWriter bw, String splitdir, int iFold) throws IOException {
		...
		String testLabeled = splitdir + "test." + iFold + ".txt";
