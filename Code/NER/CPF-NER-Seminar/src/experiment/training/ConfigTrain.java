...
public class ConfigTrain {
	...
	public ParaClass Configure(String dir, int iFold, String paradir, String splitdir) throws IOException {
		String WordDicFn = splitdir + "fea_map.txt";
		...
		String trainLabeled = splitdir + "labeled." + iFold + ".txt";
		String trainUnlabeled = splitdir + "unlabeled." + iFold + ".txt";
		...
		pgc.GenPara(gdd.nFeatures, mpc.b, splitdir, paradir); // comment this line if want to re-use the parameters
		...
		// try parameter
		pgc.w.put("stime_etime_earlier", 1.0);
