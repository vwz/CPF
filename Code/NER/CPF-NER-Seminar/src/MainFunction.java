...
public class MainFunction {
	...
	public static void Process(double alpha1, double alpha2, double alpha3) {
		...
		String dir = workspace + "/cikm2016-cpf/Data/NER/Seminar/"; // make sure you have the directory
		String res = workspace + "/cikm2016-cpf/Prediction/NER/Seminar/cpf " + para + ".txt"; // make sure you have the directory

		System.out.println("alpha1 = " + mpc.alpha1 + ", alpha2 = " + mpc.alpha2 + ", alpha3 = " + mpc.alpha3);

		String splitdir = dir + "splits/";
		int nFolds = 5;
		...
		try {
			...
			for (int i = 0; i < nFolds; i++) {
				String paradir = workspace + "/cikm2016-cpf/Parameter/NER/Seminar/";

				// training
				long tstart = System.currentTimeMillis();
				ParaClass param = ct.Configure(dir, i, paradir, splitdir);
				...
				Evaluator eval = cd.Configure(dir, param, bw, splitdir, i);
