...
public class DecoderClass {
	...
	public void GibbsSampling(dataStructure ds, List<ObsClass> obsList, EdgeStructClass edgeStruct, EdgeStructClass edgeStructCons, InferClass inferP) {
		...
		for (int iter = 0; iter < maxDecoderIter; iter++) {
			...
			for (int i = 0; i < ds.data.size(); i++) {
				...
				if (lc.line.equals("STRIPS	title	strip|.|:|true|false|false|NNS"))
