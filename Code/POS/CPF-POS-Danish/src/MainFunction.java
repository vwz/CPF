...
public class MainFunction {
	...
	public static void Process(double alpha1, double alpha2, double alpha3) {
		...
		String dir = workspace + "/cikm2016-cpf/Data/POS/CoNLL-X_Shared_Task/danish/features/";
		String res = workspace + "/cikm2016-cpf/Prediction/POS/CoNLL-X_Shared_Task/danish/cpf " + para + ".txt";
		...
		try {
			...
			for (int i = 0; i < nFolds; i++) {
				String paradir = workspace + "/cikm2016-cpf/Parameter/POS/CoNLL-X_Shared_Task/danish/";
