...
public class ConfigTrain {
	...
	public ParaClass Configure(String dir, int iFold, String paradir, int numdata) throws IOException {
		...
		String trainLabeled = dir + "train." + numdata + ".labeled." + iFold + ".txt";
		String trainUnlabeled = dir + "train." + numdata + ".unlabeled." + iFold + ".txt";
		...
		pgc.GenPara(gdd.nFeatures, mpc.b, dir, paradir); // comment this line if want to re-use the parameter
		...
		// try parameter
		pgc.w.put("CONJ_notinlast", 1.0);
		pgc.w.put("ADJ_NUM_faraway", 3.0);
